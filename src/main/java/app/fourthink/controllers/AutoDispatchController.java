...
@Controller
@RequestMapping("/me/auto")
public class AutoDispatchController {

    private final AutoDispatchService autoDispatch;

    @Autowired
    public AutoDispatchController(AutoDispatchService autoDispatch) {
    ...
    public String request(HttpSession session,
        ...
        autoDispatch.request(SessionGate.customerId(session), latitude, longitude,
